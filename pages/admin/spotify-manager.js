    ...
    <Layout>
      <div className="max-w-6xl mx-auto px-4 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-[#121212] rounded-xl p-4 border border-neutral-800">
            <p className="text-neutral-400 text-sm">冇相片</p>
            <p className="text-2xl font-bold text-[#FFD700]">{stats.artistsWithoutPhoto}</p>
          </div>
          <div className="bg-[#121212] rounded-xl p-4 border border-neutral-800">
            <p className="text-neutral-400 text-sm">譜總數</p>
            <p className="text-2xl font-bold text-white">{stats.totalTabs}</p>
          </div>
          <div className="bg-[#121212] rounded-xl p-4 border border-neutral-800">
            <p className="text-neutral-400 text-sm">冇 Spotify</p>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <label className="flex items-center gap-2 text-sm text-neutral-400 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-neutral-600 text-[#1DB954]"
                  />
                  強制更新所有歌手
                </label>
                <button
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
              {(showAllArtists ? artists : artists.filter(a => !a.photoURL && !a.wikiPhotoURL))
                .map(artist => (
                  <div key={artist.id} className="bg-[#121212] rounded-lg p-3 border border-neutral-800">
                    <div className="aspect-square rounded-lg bg-neutral-800 mb-2 flex items-center justify-center text-2xl overflow-hidden">
                    ...
                    <p className="text-neutral-500 text-xs">{artist.songCount || 0} 首歌</p>
                    {artist.wikiPhotoURL && (
              ...
              <div className="bg-[#121212] rounded-xl p-4 border border-neutral-800">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-neutral-400">Spotify ID: {searchResults.id}</p>
                    <p className="text-neutral-400">圖片: {searchResults.images?.length || 0} 張</p>
                    <button
                      onClick={() => {/* 更新到譜 */}}
            ...
            <div className="bg-[#121212] rounded-xl p-4 border border-neutral-800">
              ...
              <div className="space-y-3">
                <button
                  onClick={bulkUpdateArtists}
                  disabled={isBulkUpdating}
                  className="w-full flex items-center justify-between p-4 bg-neutral-900 rounded-lg hover:bg-neutral-800 transition"
                >
                  <div className="text-left">
                    <p className="text-white font-medium">🖼️ 更新所有歌手相片</p>
                    <p className="text-neutral-500 text-sm">為 {stats.artistsWithoutPhoto} 個冇相片嘅歌手搜尋 Spotify 相片</p>
                  </div>
