...
export default function LikedSongs() {
  ...
  return (
    <div className="min-h-screen bg-black pb-20">
      {/* Header */}
      <div className="px-4 pt-6 pb-4 flex items-center space-x-3 sticky top-0 bg-black/95 backdrop-blur-sm z-10">
            ...
            {songs.map((song, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className="text-[#B3B3B3] text-sm truncate">{song.artistName}</p>
                </div>
