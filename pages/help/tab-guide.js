      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#121212] rounded-xl border border-neutral-800 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
            <div className="bg-black rounded-lg p-3">
              ...
              <span className="text-neutral-400 ml-2">→ Verse（主歌）</span>
            </div>
            <div className="bg-black rounded-lg p-3">
              <code className="text-[#FFD700]">/c</code>
              <span className="text-neutral-400 ml-2">→ Chorus（副歌）</span>
            </div>
            <div className="bg-black rounded-lg p-3">
              <code className="text-[#FFD700]">/p</code>
              <span className="text-neutral-400 ml-2">→ Pre-chorus</span>
            </div>
            <div className="bg-black rounded-lg p-3">
              <code className="text-[#FFD700]">/b</code>
              <span className="text-neutral-400 ml-2">→ Bridge（橋段）</span>
            </div>
            <div className="bg-black rounded-lg p-3">
              <code className="text-[#FFD700]">/i</code>
              <span className="text-neutral-400 ml-2">→ Intro（前奏）</span>
            </div>
            <div className="bg-black rounded-lg p-3">
              <code className="text-[#FFD700]">/o</code>
              <span className="text-neutral-400 ml-2">→ Outro（尾奏）</span>
            </div>
          </div>
        ...
        <div className="bg-[#121212] rounded-xl border border-neutral-800 p-6 mb-6">
          ...
          <div className="bg-black rounded-lg p-4 font-mono text-sm">
            ...
            <p className="text-neutral-300">|C      G/B    |Am     F</p>
            <p className="text-neutral-300">(這裡)可以(加)入旁白</p>
            <p className="text-neutral-400 italic text-xs mt-2">// 這行會顯示為斜體細字</p>
          </div>
        </div>
        ...
        <div className="bg-[#121212] rounded-xl border border-neutral-800 p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="bg-black rounded-lg p-4 font-mono text-sm text-neutral-300">
                <p>|C      G/B    |Am     F</p>
                <p>(暗)如何(蠶)食了(光)</p>
              </div>
            </div>
        ...
        <div className="bg-[#1a1a2e] rounded-xl border border-[#FFD700]/30 p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-white font-medium">出譜者名稱</h3>
                <p className="text-neutral-400 text-sm">
                  這是辨識你作品的方式！建議先到 
        ...
        {/* Pen Name Setup */}
        <div className="bg-[#121212] rounded-xl border border-neutral-800 p-6 mb-6">
          <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2"><Pencil className="w-5 h-5" /> 設定你的出譜者名稱</h2>
