...
/** Only fields needed for home SongCard: id, title, artistId; one image — coverImage, or artistPhoto only when no cover (saves payload). 多歌手時帶上 artist 顯示名（如 MC 張天賦 feat. Billy Choi）供首頁顯示。 */
