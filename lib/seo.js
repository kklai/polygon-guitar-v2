...
// 生成歌手頁面標題
export function generateArtistTitle(artistName, songCount) {
  return `${artistName} 結他譜 ${songCount}首 Chords Tabs | Polygon Guitar`
}
...
export function generateTabSchema(tab, artist) {
  return {
    ...
    image: tab.thumbnail || artist?.photoURL,
